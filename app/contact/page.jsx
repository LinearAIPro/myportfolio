...
const info = [
  {
    icon: <FaPhoneAlt />,
    title: "Phone",
    description: "(+48) 608774020",
    action: () => (window.location.href = "tel:+48608774020"),
  },
  {
    icon: <FaEnvelope />,
    title: "Email",
    description: "denysstefaniuk@outlook.com",
    action: () => (window.location.href = "mailto:denysstefaniuk@outlook.com"),
  },
  {
    icon: <FaMapMarkerAlt />,
    title: "Location",
    ...
    action: () =>
      window.open("https://www.google.com/maps?q=Warsaw+Poland", "_blank"),
  },
];
          ...
          <div className="w-full h-[524px] max-w-[500px] flex flex-col justify-between gap-6">
            ...
            <div className="flex flex-col justify-center items-center gap-2 rounded-xl p-[30px] bg-black/10 text-white">
              ...
              <p className="p max-w-[336px] mx-auto text-center">
                Reach out me to discuss opportunities, projects, or simply to start
                a conversation.
              </p>
            </div>
            {/* info */}
