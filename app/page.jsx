          ...
          <div className="flex flex-col gap-4 w-auto max-w-[380px] text-center xl:text-left">
            ...
            >
              <h1 className="h1">
                Hello,
                <br />
                I'm <span className="text-accent">Denys!</span>
              </h1>
            </motion.div>
            {/* bio */}
            <motion.div
            ...
            >
              <p>
                A wizard in the realm of Full Stack Development and AI, with 
                a special affinity for crafting web applications that are not just functional but also intelligent and user-friendly.
                With the alchemy of Typescript, I transform ideas into digital realities.
              </p>
            </motion.div>
            {/* take action */}
            <motion.h3
            ...
            >
              Let's embark on a code odyssey together!
            </motion.h3>
            {/* btn and socials */}
